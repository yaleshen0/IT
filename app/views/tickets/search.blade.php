          ...
          <span style="font-size: 34px; color:black;" class="page-header">
            ...
            <div class="dropdown" style="display: inline;">
              ...
              <div class="search">
                ...
                <input type="text" name="" class="types" value="{{$type}}" style="display: inline; font-size: 16px; width:66px;" disabled/><span style="font-size: 16px;" class="glyphicon glyphicon-remove"></span>
                @endforeach
              </div>
            </div>
          </span>
